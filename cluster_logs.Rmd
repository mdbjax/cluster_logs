...
dfSummary(helix.monthly, plain.ascii = FALSE, style="grid", graph.magnif = 0.75, valid.col=FALSE)
dfSummary(cadillac.monthly, plain.ascii = FALSE, style="grid", graph.magnif = 0.75, valid.col=FALSE)
```
